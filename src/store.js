;(function () {
  ...
  function Store(options) {
    ...
    if (typeof options.recipe === 'object') {
  ...
  Store.prototype.addRule = function (name, rule) {
    if (rule instanceof Pharmacy.Rule === false) {
      rule = new Pharmacy.Rule(rule);
    }
  ...
  Store.prototype.addRecipe = function (name, recipe) {
    if (recipe instanceof Pharmacy.Recipe === false) {
      recipe = new Pharmacy.Rule(recipe);
    }
